...
// http://www.ecma-international.org/ecma-262/6.0/#sec-toprimitive
    ...
    }, {"./helpers/isPrimitive": 43, "is-callable": 44, "is-date-object": 46, "is-symbol": 45}],
...
// https://es5.github.io/#x9
    ...
    }, {"./helpers/isPrimitive": 43, "is-callable": 44}],
...
// https://people.mozilla.org/~jorendorff/es6-draft.html#sec-abstract-operations
        ...
        "has": 41,
        "es-to-primitive/es6": 40,
        "./helpers/isNaN": 33,
        "./helpers/isFinite": 34,
        "./helpers/assign": 35,
        "./helpers/sign": 36,
        "./helpers/mod": 37,
        "./helpers/isPrimitive": 43,
        "function-bind": 42,
        "./es5": 32,
        "is-regex": 39
    }],
    ...
    }, {"es-abstract/es6": 25, "define-properties": 12}],
    ...
    }, {"es-abstract/es6": 25, "./implementation": 9}],
    ...
    }, {"define-properties": 12, "./polyfill": 10}],
...
// eslint-disable-next-line no-unused-vars
    ...
    }, {"define-properties": 12, "./implementation": 9, "./polyfill": 10, "./shim": 11}],
...
// Jaime Pillora <dev@jpillora.com> - MIT Copyright 2016
        ...
        XHookHttpRequest = window[XMLHTTP] = function () {
            var ABORTED, currentState, emitFinal, emitReadyState, event, facade, hasError, hasErrorHandler, readBody,
                readHead, request, response, setReadyState, status, transiting, writeBody, writeHead, xhr, _i, _len,
                _ref;
            ABORTED = -1;
...
//enables slave listeners
    ...
    }, {"../vendor/xhook": 4, "./config": 19, "./util": 16}],
...
//  passes events to existing sockets (created by connect or by the server)
    ...
    }, {"../vendor/xhook": 4, "./config": 19, "./util": 16, "./slave": 28}],
...
//is the arguments object
    ...
    }, {"../vendor/xhook": 4, "./config": 19, "./util": 16, "./socket": 17}],
...
//auto init using attributes
    ...
    }, {"./config": 19, "./util": 16, "./master": 29, "./slave": 28}],
...
//config is also the primary intialise function
    ...
    }, {"./lib/util": 16, "./lib/socket": 17, "./lib/script": 18, "./lib/config": 19}],
